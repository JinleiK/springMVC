...
public class User {
	...
	@Size(min=4, max=15, message="Password must be 4-15 long", groups={FormValidationGroup.class})
	private String password;
	private boolean enabled = false;
	@NotBlank(groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	@Size(min=5, max= 60, message="name must be between 5 and 60 characters", groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	private String name;
	...
	public User(String username, String password, boolean enabled, String name,
			String authority) {
